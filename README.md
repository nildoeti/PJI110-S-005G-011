...
facilitador para a comunicação entre a ONG, responsáveis e a
comunidade.
Também que permita fazer registro de informações para possiveis intressados a partir
de um formulário de contato no site, que possua um banco de dados para armazementos
das informações, facilitando pesquisas, dos
dados e que garanta a segurança das informações armazenadas.

## Objetivo
Contrução do web site conectado em um banco de dados para 
...
## Tecnologias em uso   
- [SO Fedora Linux](https://fedoraproject.org/)
